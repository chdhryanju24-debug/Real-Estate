...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "735c8feb-b06b-4594-8f90-a0336db8159c");
    ...
    return (
        <motion.div
            ...
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
                ...
                <button className='bg-blue-600 text-white py-2 px-12 mb-10 rounded'>{result ? result : "Send Massage"}</button>
            </form>
        </motion.div>
    )
}
